# This Makefile is for the Ogg::Vorbis extension to perl.
#
...
#	DEFINE => q[]
#	EXE_FILES => [q[pogg]]
#	INC => q[-I/usr/local/include/vorbis]
#	LIBS => [q[-logg -lvorbis -lvorbisfile]]
#	NAME => q[Ogg::Vorbis]
#	VERSION_FROM => q[Vorbis.pm]
...
INSTALLMAN1DIR = /home/foof/src/projects/libvorbis-perl-0.04/debian/tmp$(PREFIX)/share/man/man1
INSTALLSITEMAN1DIR = $(SITEPREFIX)/man/man1
MAN1EXT = 1p
INST_MAN3DIR = blib/man3
INSTALLMAN3DIR = /home/foof/src/projects/libvorbis-perl-0.04/debian/tmp$(PREFIX)/share/man/man3
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Ogg
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Ogg
...
TO_INST_PM = Vorbis.pm

PM_TO_BLIB = Vorbis.pm \
	$(INST_LIBDIR)/Vorbis.pm
...
XSUBPPDIR = /usr/share/perl/5.6.1/ExtUtils
...
# Ogg::Vorbis might depend on some other libraries:
# See ExtUtils::Liblist for details
#
EXTRALIBS = -logg -lvorbis -lvorbisfile
LDLOADLIBS = -logg -lvorbis -lvorbisfile
BSLOADLIBS = 
LD_RUN_PATH = 
...
manifypods : pure_all pogg \
	Vorbis.pm
	@$(POD2MAN) \
	pogg \
	$(INST_MAN1DIR)/pogg.$(MAN1EXT) \
	Vorbis.pm \
	$(INST_MAN3DIR)/Ogg::Vorbis.$(MAN3EXT)
...
pure_all :: $(INST_SCRIPT)/pogg
	@$(NOOP)

realclean ::
	rm -f $(INST_SCRIPT)/pogg

$(INST_SCRIPT)/pogg: pogg Makefile $(INST_SCRIPT)/.exists
	@rm -f $(INST_SCRIPT)/pogg
	cp pogg $(INST_SCRIPT)/pogg
	$(FIXIN) $(INST_SCRIPT)/pogg
	-@$(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/pogg
...
clean ::
	-rm -rf Vorbis.c ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all perlmain.c mon.out core core.*perl.*.? *perl.core so_locations pm_to_blib *$(OBJ_EXT) *$(LIB_EXT) perl.exe $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def $(BASEEXT).exp
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Ogg-Vorbis\" VERSION=\"0,04,0,0\">\n}. qq{\t<TITLE>Ogg-Vorbis</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Ogg-Vorbis.ppd
